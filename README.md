...
| 🤖 **Генерация с помощью ИИ**    | Используется любую текстовую модель                             |
...
Приложение может использовать все текстовые модели, напрмиер такие как **Gemma-3-4b-it-qat** для генерации высококачественных бизнес-планов. Коммуникация происходит через защищённые HTTP-запросы, результаты автоматически форматируются и сохраняются в базу данных.
